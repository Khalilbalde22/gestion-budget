...
if(isset($_GET['id'])){
        ...
        $sql = "SELECT * FROM `gestion_budget`.`depense` WHERE `id` = '$id' ";
...
//traitement du formulaire de modification
 ...
 if (isset($_POST['submit'])){
         ...
         && !empty($_POST['date'])){
            ...
            // $sql = ("INSERT INTO 'depense'('reference','montant') VALUES (:reference, :montant)");
            $sql = ("UPDATE `gestion_budget`.`depense` SET `reference`='$reference', `montant`='$montant', `type`='$type', `date`='$date' WHERE  `id`=$id");
