          ...
          <div class="menu-inner-shadow"></div>
            ...
            <ul class="menu-inner py-1">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                    <a href="revenu.php" class="menu-link">
                        <div data-i18n="Without menu">Ajouter un revenu</div>
                    </a>
                    </li>
                    <li class="menu-item">
                    <a href="historiqueRevenu.php" class="menu-link">
        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              <!-- la bare de recherce dans le contenu -->
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Khalil Balde</span>
                    ...
                    <li>
                      <form action="deconnexion.php" method="post">
                          <button class="dropdown-item btn btn-secondary" type = "submit" style="color:red;">
          ...
          <!-- / Navbar de haut de la recherche -->
